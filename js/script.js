...
{
	var desc0 = "A Social Media and Political Commentary and Text-Adventure, Seemingly About Kanye West (Twine 2/CSS)"
	makeNewProject( "Make Yeezy Great Again", "myga", desc0 );

	var desc1 = "A Conceptual Infinite Runner with Audio-Input (Unity3D/Adobe Suite/Logic Pro X)"
	makeNewProject( "Speak UP!", "su", desc1 );

	var desc2 = "A Basic 3D Fighting Game for PlayStation 4 (Unity3D)"
	makeNewProject( "3D Fighter", "tdf", desc2 );

	var desc3 = "An Audio-Visual Multi-Album Experience (Unity3D/Logic Pro X)"
	makeNewProject( "Music Explorer", "me", desc3 );

	var desc4 = "A Music Program with Interactive Audio Input (P5.js/JavaScript)"
	makeNewProject( "Not All Heroes Wear Capes", "nahwc", desc4 );

	var desc5 = "A Compilation of Most Recent Works + 1 Draft Process (Adobe Suite)"
	makeNewProject( "[Visual Designs]", "portvisual", desc5 );

	var desc6 = "A Robotron: 2084 Remake/Sequel - New Modes/Enemy (GameMaker 2/GML)"
	makeNewProject( "Robotron: 2094 (SuperTron)", "st", desc6 );

	var desc7 = "An Abstract Program Reflecting on Equality (Processing/Java)"
	makeNewProject( "A Story of Black and White", "sobaw", desc7 );

	var desc8 = "A Basic Escape Game With Different Obstacles (P5.js/JavaScript)"
	makeNewProject( "BlockIT", "bi", desc8 );

	var desc9 = "A Conceptual Website Using Articles as a Memoir (JavaScript/NYTimes API)"
	makeNewProject( "My Beautiful Grey Twisted Reality", "mbgtr", desc9 );

	var desc10 = "A Personal Blog Organized by Type and Tone of Subject Matter (JavaScript)"
	makeNewProject( "Nigmatic World", "nw", desc10 );

	var desc11 = "An iOS Whack-A-Mole Game with Various Modes (GameSalad)"
	makeNewProject( "Touch Adventure", "ta", desc11 );
}
